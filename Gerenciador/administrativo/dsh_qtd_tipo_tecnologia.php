		  ...
		  google.charts.setOnLoadCallback(drawStuff);
			  ...
			  function drawStuff() {
				var data = new google.visualization.arrayToDataTable([
				  ...
				  <?php echo "['11 a 19'," .$consultaQtdIccidPorRegionaleTecnologia->pegaQtdPorRegionaleTecnologia('11', 1,'SIM').",".$consultaQtdIccidPorRegionaleTecnologia->pegaQtdPorRegionaleTecnologia('11',1,'USIM')."]";?>,
