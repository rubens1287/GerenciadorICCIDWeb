...
<html lang="pt-br">
  ...
  <body >
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="row">
        <div class="col-md-6">
            <form class="form-horizontal" method="POST" action="processo/processo_atualiza_usuario.php">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="email" class="form-control" name="ed_email" 
						 placeholder="E-mail" value="<?php echo $resultado['lg_email'];?>">
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" name="ed_nivel_acesso">
						
						<option value=""
						<?php
							if(empty($resultado['lg_nivel_de_acesso'])){
								echo 'selected';
							}
						?>
						>Selecione</option>
						...
						<option value="2" 
						<?php
							if($resultado['lg_nivel_de_acesso'] == 2){
								echo 'selected';
							}
						?>
						>Usuário</option>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" class="form-control" name="cad_dt_criacao" 
						 placeholder="Data de criação" value="<?php echo $resultado['lg_criado'];?>">
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" class="form-control" name="cad_dt_modificado" 
						 placeholder="Data de modificação" value="<?php echo $resultado['lg_modificada'];?>">
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" name="ed_status">
						
						<option value=""
						<?php
							if(empty($resultado['lg_status'])){
								echo 'selected';
							}
						?>
						>Selecione</option>
			  ...
			  <div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
				  ...
				  <a href="administrativo.php?link=2" <button type="submit" class="btn btn-primary">Voltar</button></a>
				</div>
			  </div>
